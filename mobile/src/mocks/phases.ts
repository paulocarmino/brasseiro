    ...
    // ===== FASE 2: MOSTURA =====
    {
      ...
      steps: [
        ...
        },
        {
          ...
          scienceNote:
            "Nessa temperatura, as enzimas alfa e beta amilase estao trabalhando pesado, quebrando o amido dos graos em acucares fermentaveis. Temperatura mais alta (~68-72C) = mais dextrinas = cerveja mais encorpada. Temperatura mais baixa (~62-65C) = mais acucares simples = cerveja mais seca e alcoolica.",
        ...
        },
        {
          ...
          description:
            "Enquanto a mostura rola, aqueca ~2 litros de agua separadamente ate 70C. Essa agua vai ser usada pra lavar os graos depois e extrair mais acucares.",
          parallelTasks: [
            {
              index: 0,
              type: "action",
              ...
              description:
                "Em outra panela (pode ser uma panelinha de casa), aqueca 2L de agua mineral ate 70C.",
            },
          ],
        ...
        },
        {
          ...
          description:
            "Levante o bag devagar e deixe escorrer. Use um escorredor de macarrao pra apoiar. Despeje a agua de lavagem quente (70C) sobre o bag pra extrair os acucares restantes. Pode espremer o bag sim — diferente do que muitos dizem, apertar nao extrai taninos em excesso.",
          scienceNote:
        ...
        },
        {
          ...
          parallelTasks: [
            ...
            },
            {
              ...
              description:
                "Coloque ~200ml de agua filtrada num copo, aqueca no micro-ondas por 2 minutos (so pra esterilizar), depois deixe esfriar ate temperatura ambiente (~25-30C). Quando esfriar, abra o sachet de levedura e despeje na agua. Nao mexa — deixe ela hidratar por pelo menos 15 minutos.",
            },
          ],
      ...
      steps: [
        {
          ...
          title: "Banho de gelo",
          description:
            "Coloque a panela na pia com bastante gelo e agua fria ao redor. O objetivo e baixar a temperatura o mais rapido possivel. Com banho de gelo domestico, e dificil baixar de 30C, entao pode transferir pro fermentador e colocar na geladeira pra terminar de resfriar.",
          scienceNote:
        ...
        },
        {
          ...
          description:
            "Coloque o fermentador dentro de um cooler ou caixa com garrafas PET congeladas ou bolsas de gelo. O objetivo e manter abaixo de 20C durante toda a fermentacao. Troque o gelo de manha e a noite. Dica: coloque um copo com agua e o termometro dentro do cooler pra monitorar a temperatura.",
          scienceNote:
            "Temperatura e o fator #1 na qualidade da fermentacao. Acima de 20C, a levedura produz mais esteres e fenois (off-flavors). Quanto mais estavel a temperatura, mais limpa e suave a cerveja fica. E melhor manter constante em 19C do que ficar variando entre 15C e 22C.",
        ...
        session.envaseType === "priming"
          ? [
              ...
              },
              {
                ...
                description:
                  "Feche as garrafas bem apertado. Coloque numa caixa de papelao em um cantinho fresco da casa (20-25C). Minimo 7 dias, ideal 10 dias. Dica: aperte a garrafa PET pra sentir se ta dura — se tiver bem dura, a carbonatacao ta boa!",
                scienceNote:
