...
export const glossary: GlossaryEntry[] = [
  {
    term: "ABV",
    definition:
      "Alcohol By Volume. Percentual de alcool na cerveja. Calculado pela formula: (OG - FG) x 131.25.",
  ...
  },
  {
    term: "Atenuacao",
    definition:
      "Percentual de acucares que a levedura conseguiu consumir. Calculado como (OG - FG) / (OG - 1) x 100. Atenuacao alta = cerveja mais seca.",
    aliases: [],
  },
  {
    term: "BIAB",
  ...
  },
  {
    term: "Cold crash",
    definition:
      "Resfriamento drastico da cerveja (proximo a 0C) apos a fermentacao para clarificar. A levedura e proteinas decantam no fundo. Minimo 4-5 dias na geladeira.",
  ...
  },
  {
    term: "Fermentacao",
    definition:
      "Processo onde a levedura consome os acucares do mosto e produz alcool e CO2. Temperatura ideal depende da cepa, mas geralmente abaixo de 20C para ales. Dura cerca de 6-7 dias.",
    aliases: ["fermentar"],
  },
  {
    term: "Hidratacao de levedura",
    definition:
      "Processo de reidratar a levedura seca em agua morna esterilizada (~30C) antes de adicionar ao mosto. Melhora significativamente a saude e velocidade da fermentacao.",
  ...
  },
  {
    term: "Inoculacao",
    definition:
      "Ato de adicionar a levedura ao mosto resfriado (tambem chamado de 'pitch'). O mosto deve estar abaixo de 25C para nao matar a levedura.",
  ...
  },
  {
    term: "Mostura",
    definition:
      "Etapa onde os graos moidos sao misturados com agua quente (62-72C) para converter amido em acucares fermentaveis. As enzimas alfa e beta amilase fazem essa conversao. Dura 30-60 minutos.",
  ...
  },
  {
    term: "Sparge",
    definition:
      "Lavagem dos graos com agua quente (~70C) apos a mostura para extrair o maximo de acucares. No BIAB, geralmente se faz com 2L de agua quente despejados sobre o bag.",
